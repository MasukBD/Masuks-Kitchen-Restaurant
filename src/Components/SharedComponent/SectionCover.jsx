...
const SectionCover = ({ image, heading, subHeading }) => {
    return (
        <div className='relative'>
            <img src={image} alt="" />
            <div className='absolute bg-black bg-opacity-70 mx-14 my-8 md:my-20 md:mx-20 inset-0 flex flex-col items-center justify-center text-center text-white space-y-3'>
