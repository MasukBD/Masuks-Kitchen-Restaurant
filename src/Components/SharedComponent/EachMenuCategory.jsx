...
const EachMenuCategory = ({ menu }) => {
    return (
        <>
            ...
            <p className='text-center mt-5'><Link to=""><button className='mb-8 mt-5 border-black border-b-2 font-semibold '>Order Now</button></Link></p>
        </>
