...
const ItemShowInCard = ({ item }) => {
    ...
    return (
        <div className='relative shadow-lg flex flex-col text-center shadow-orange-100 border'>
            ...
            <Link className='mt-auto mb-5' to=""><button onClick={() => handleAddToCart(item)} className='border-b-2 py-1 px-2 border-orange-500 text-warning hover:bg-black font-semibold'>Add To Cart</button></Link>
        </div>
    );
};
