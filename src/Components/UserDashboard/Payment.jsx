    ...
    return (
        <>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-5'>
                <div className='lg:h-screen flex items-center flex-col gap-5 justify-center'>
                    <Lottie animationData={Animation} loop={true} />
                    <Marquee className='text-error font-semibold p-2'>
                        <p>&nbsp; Please Do Not give any Actual Card Number to Check. Better you can try some test Card Data From stripe.com/docs/testing. Thank you!  </p>
                    </Marquee>
                </div>
                <div>
                    ...
                    <div className='p-2 w-11/12 mx-auto mt-6 mb-6 lg:mb-10'>
                        ...
                        <Elements stripe={stripePromise}>
                            <PaymentForm cartItem={cart} price={price}></PaymentForm>
                        </Elements>
                    </div>
